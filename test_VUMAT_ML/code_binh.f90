...
real :: old_PEEQ, old_strain_rate, old_temp
...
! Transform and normalize inputs for ML model
		log_old_PEEQ = log10(old_PEEQ)
		log_old_strain_rate = log10(old_strain_rate)
		norm_PEEQ = (log_old_PEEQ - log_PEEQ_min) / log_PEEQ_max
		norm_strain_rate = (log_old_strain_rate - log_strain_rate_min) / log_strain_rate_max
		norm_temp = (old_temp - temp_min) / temp_max
